    ...
    return (
      <div className="max-w-6xl mx-auto p-4">
        <div className="bg-red-900 border border-red-700 rounded-lg p-6">
          <h2 className="text-xl font-semibold text-red-200 mb-2">오류 발생</h2>
  ...
  return (
    <div className="max-w-6xl mx-auto p-4 space-y-6">
      <div className="text-center mb-8">
        <h1 className="text-4xl font-bold text-white mb-2">달러 투자 적정 시기 분석</h1>
        <p className="text-gray-300 mt-2">데이터가 알려주는 투자 최적기</p>
      </div>
